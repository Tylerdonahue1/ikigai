    ...
    <div className="min-h-screen bg-white py-8 md:py-16 px-4 md:px-8">
      <div className="max-w-[1024px] mx-auto">
        ...
        <div className="mb-8 md:mb-12 text-center">
          ...
          <p className="text-lg md:text-xl text-[#3D405B]  mb-6 md:mb-8">
            Here's a preview of your Ikigai assessment. Unlock the full report
            to discover your unique purpose.
          </p>
        </div>
        ...
        <div className="bg-[#F4F1DE] rounded-lg p-6 md:p-8 shadow-md mb-10 md:mb-12">
          ...
          <p className="text-base md:text-lg text-[#3D405B]  mb-6 text-center">
            Your full report includes detailed insights, personalized
            suggestions, and role model inspirations to help you live a more
            fulfilling life aligned with your Ikigai.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            <Card className="bg-white p-5 md:p-6 rounded-lg shadow-md">
              ...
              <p className="text-sm md:text-base text-[#3D405B]">
                In-depth exploration of your passions, skills, values, and
                potential career paths aligned with your Ikigai.
              </p>
            </Card>
            ...
            <Card className="bg-white p-5 md:p-6 rounded-lg shadow-md">
              ...
              <p className="text-sm md:text-base text-[#3D405B]">
                Actionable recommendations for projects, careers, and activities
                that align with your unique Ikigai.
              </p>
            </Card>
            ...
            <Card className="bg-white p-5 md:p-6 rounded-lg shadow-md">
              ...
              <p className="text-sm md:text-base text-[#3D405B]">
                Profiles of people who embody elements of your Ikigai, providing
                real-world inspiration and insights.
              </p>
            </Card>
          </div>
        </div>
